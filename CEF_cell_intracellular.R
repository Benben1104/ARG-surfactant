...
ggsave("E.coli_CEF+SDS_in.png", width=690/90, height=420/90, dpi=600, unit="in")
...
ggsave("E.coli_CEF+DTAC_in.png", width=690/90, height=420/90, dpi=600, unit="in")
...
ggsave("E.coli_CEF+TX-100_in.png", width=690/90, height=420/90, dpi=600, unit="in")
