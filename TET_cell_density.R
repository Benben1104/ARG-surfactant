...
ggsave("E.coli_TET+SDS.png", width=690/90, height=420/90, dpi=600, unit="in")
...
ggsave("E.coli_TET+DTAC.png", width=690/90, height=420/90, dpi=600, unit="in")
...
ggsave("E.coli_TET+TX-100.png", width=690/90, height=420/90, dpi=600, unit="in")
